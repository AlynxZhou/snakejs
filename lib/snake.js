...
(function() {
  ...
  App = (function() {
    ...
    App.prototype.createDom = function(DomCreator) {
      ...
      this.domCreator.createPara(settingDiv, "选择地图");
      this.mapRadio = [this.domCreator.createRadio(settingDiv, "snakeMap", "map0", "无地图", "snakeMap0", true), this.domCreator.createRadio(settingDiv, "snakeMap", "map1", "地图一", "snakeMap1"), this.domCreator.createRadio(settingDiv, "snakeMap", "map2", "地图二", "snakeMap2")];
